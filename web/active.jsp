        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form" action="active" method="post">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Mã kích hoạt không được để trống">
                            <input class="input100" type="text" name="codeactive">
                            <span class="focus-input100" data-placeholder="Nhập Mã Kích Hoạt"></span>
                        </div>
