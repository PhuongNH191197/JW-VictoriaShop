    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (account == null) {
                ...
                int productDetailID = account.getAcountDetailId();
                AccountDetailService accountDetailService = new AccountDetailService();
                if (fullname != null && phone != null && address != null) {
                    accountDetailService.updateDetailAccount(fullname, phone, address, productDetailID);
                }
                AccountDetail accountDetail = accountDetailService.getDetailById(productDetailID);
                request.setAttribute("detailAccount", accountDetail);
