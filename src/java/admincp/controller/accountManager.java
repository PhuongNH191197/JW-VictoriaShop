 ...
 * @author PhuongPyke
 */
@WebServlet(name = "adminCpFillter", urlPatterns = {"/accountmanager"})
public class accountManager extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (accountId != null) {
                AccountDetail accountDetail = accountDetailService.getDetailById(Integer.parseInt(accountId));
                request.setAttribute("listAccountDetail", accountDetail);
